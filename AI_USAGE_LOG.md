...
| 2026-07-13 | Nalluraj Babu          | Claude - Opus | I built the Phase 2 pipeline; used Claude to review and sanity-check my implementation | Verified against my run - confirmed array shapes, split sizes, and metric outputs on the seed-42 data matched what I expected |
...
| 2026-07-14 | Nalluraj Babu.         | Claude - Sonnet | Researched about existing ML models.     | Understood and studied how the unsupervised learning model works. |      |
